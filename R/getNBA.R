...
for(x in 1998:current_year){
  ...
  Eastern_conference_season_table <- as.data.frame(rvest::html_table(team_html_tables[[1]], fill=T))
  ...
  Western_conference_season_table <- as.data.frame(rvest::html_table(team_html_tables[[2]], fill=T))
